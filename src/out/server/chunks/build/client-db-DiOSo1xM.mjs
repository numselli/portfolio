import { k as prefixStorage, af as createStorage, ag as memoryDriver, P as withBase, ab as pascalCase, M as joinURL } from '../nitro/nitro.mjs';
import { G as createQuery, b as useNuxtApp, g as useRuntimeConfig, x as useContentPreview, B as omit$1, y as get$1, z as assertArray, A as ensureArray, C as sortList, D as apply, E as withoutKeys, F as withKeys } from './server.mjs';
import 'lru-cache';
import 'devalue';
...
function createPipelineFetcher(getContentsList) {
  ...
  return async (query) => {
    ...
    if (params.first) {
      return {
        ...omit$1(["skip", "limit", "total"])(result),
...
//# sourceMappingURL=client-db-DiOSo1xM.mjs.map
