import { computed, unref, mergeProps, withCtx, renderSlot, createBlock, openBlock, Fragment, renderList, useSlots, createVNode, resolveDynamicComponent, createCommentVNode, createTextVNode, toDisplayString, provide, useSSRContext } from 'vue';
...
import { b as useAppConfig, t as tv, a as useLocale, w as getSlotChildrenText, I as ImageComponent, v as _sfc_main$d, l as _sfc_main$f, s as avatarGroupInjectionKey, n as _sfc_main$g } from './server.mjs';
import { _ as _sfc_main$4 } from './Badge-BFDPxJ6k.mjs';
      ...
      _push(ssrRenderComponent(unref(Primitive), mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            return [
              hiddenCount.value > 0 ? (openBlock(), createBlock(_sfc_main$f, {
                key: 0,
                text: `+${hiddenCount.value}`,
                class: ui.value.base({ class: props.ui?.base })
          ...
          if (_push2) {
            ssrRenderSlot(_ctx.$slots, "avatar", {}, () => {
              if (__props.chip && __props.avatar) {
                _push2(ssrRenderComponent(_sfc_main$g, mergeProps({ inset: "" }, typeof __props.chip === "object" ? __props.chip : {}, { size: __props.size }), {
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      _push3(ssrRenderComponent(_sfc_main$f, mergeProps({ alt: __props.name }, __props.avatar, {
                        size: __props.size,
                        class: ui.value.avatar({ class: props.ui?.avatar })
                      }), null, _parent3, _scopeId2));
                    } else {
                      return [
                        createVNode(_sfc_main$f, mergeProps({ alt: __props.name }, __props.avatar, {
                          size: __props.size,
                          class: ui.value.avatar({ class: props.ui?.avatar })
                ...
                _push2(ssrRenderComponent(_sfc_main$f, mergeProps({ alt: __props.name }, __props.avatar, {
                  size: __props.size,
                  class: ui.value.avatar({ class: props.ui?.avatar })
                }), null, _parent2, _scopeId));
              } else {
            ...
            if (__props.to) {
              _push2(ssrRenderComponent(_sfc_main$d, mergeProps({ "aria-label": __props.name }, { to: __props.to, target: __props.target, ..._ctx.$attrs }, {
            ...
            return [
              renderSlot(_ctx.$slots, "avatar", {}, () => [
                __props.chip && __props.avatar ? (openBlock(), createBlock(_sfc_main$g, mergeProps({
                  key: 0,
                  inset: ""
                  ...
                  _: 1
                }, 16, ["size"])) : __props.avatar ? (openBlock(), createBlock(_sfc_main$f, mergeProps({
                  key: 1,
                  alt: __props.name
                }, __props.avatar, {
                  size: __props.size,
              ...
              createVNode("div", {
                ...
                __props.to ? (openBlock(), createBlock(_sfc_main$d, mergeProps({
                  key: 0,
      ...
      _push(ssrRenderComponent(unref(Primitive), mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            if (__props.to) {
              _push2(ssrRenderComponent(_sfc_main$d, mergeProps({ "aria-label": ariaLabel.value }, { to: __props.to, target: __props.target, ..._ctx.$attrs }, {
                class: "focus:outline-none peer",
                tabindex: "-1",
                raw: ""
              }), {
                            ...
                            ssrRenderList(__props.authors, (author, index) => {
                              _push3(ssrRenderComponent(_sfc_main$d, {
                                ...
                                default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                                  if (_push4) {
                                    _push4(ssrRenderComponent(_sfc_main$f, mergeProps({ ref_for: true }, author.avatar), null, _parent4, _scopeId3));
                                  } else {
                                    return [
                                      createVNode(_sfc_main$f, mergeProps({ ref_for: true }, author.avatar), null, 16)
                                    ];
                                  }
                                }),
                                _: 2
...
//# sourceMappingURL=BlogPosts-CNQ1ufsh.mjs.map
