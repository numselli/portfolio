import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { k as prefixStorage, l as useStorage, m as useNitroOrigin, n as emojiCache, o as useOgImageRuntimeConfig, f as createError, q as fetchIsland, s as normaliseFontInput, t as theme, w as withTrailingSlash, e as getQuery, v as handleCacheHeaders, x as setHeaders, y as setHeader, z as hash, A as parseURL, B as setResponseHeader, C as proxyRequest, D as sendRedirect, E as resolveContext, H as H3Error } from '../nitro/nitro.mjs';
