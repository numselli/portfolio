...
import { b as useAppConfig, g as _sfc_main$l } from './server.mjs';
import 'lru-cache';
import '@unocss/core';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      if (icon.value) {
        _push(ssrRenderComponent(_sfc_main$l, mergeProps({ name: icon.value }, _attrs), null, _parent));
      } else {
        _push(`<!---->`);
      }
    };
...
//# sourceMappingURL=CodeIcon-BJyIRrV8.mjs.map
