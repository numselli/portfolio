import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { t as prefixStorage, v as useStorage, w as useNitroOrigin, x as emojiCache, y as useOgImageRuntimeConfig, j as createError, z as fetchIsland, A as normaliseFontInput, B as theme, C as withTrailingSlash, i as getQuery, D as handleCacheHeaders, E as setHeaders, F as setHeader, G as hash, H as parseURL, I as setResponseHeader, J as proxyRequest, K as sendRedirect, L as resolveContext, M as H3Error } from '../nitro/nitro.mjs';
