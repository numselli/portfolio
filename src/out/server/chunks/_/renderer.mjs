...
import { a6 as decodeHtml, a7 as createConsola, m as useNitroOrigin, a8 as toBase64Image, P as withBase, q as fetchIsland, a9 as htmlDecodeQuotes, o as useOgImageRuntimeConfig, J as defu, s as normaliseFontInput, aa as fontCache } from '../nitro/nitro.mjs';
...
async function useSharp() {
  sharpInstance.instance = sharpInstance.instance || await import('../nitro/nitro.mjs').then(function (n) { return n.ai; }).then((m) => m.default);
  return sharpInstance.instance;
}
async function useCssInline() {
  cssInlineInstance.instance = cssInlineInstance.instance || await import('../nitro/nitro.mjs').then(function (n) { return n.ai; }).then((m) => m.default);
