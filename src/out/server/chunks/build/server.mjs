import { toValue, isRef, defineComponent, shallowRef, h, resolveComponent, useAttrs, ref, computed, mergeProps, unref, hasInjectionContext, inject, getCurrentInstance, onServerPrefetch, useSlots, withCtx, renderSlot, createBlock, createCommentVNode, openBlock, toDisplayString, createVNode, watch, resolveDynamicComponent, toRef, nextTick, provide, createElementBlock, cloneVNode, defineAsyncComponent, useSSRContext, Suspense, Fragment, createApp, renderList, useId, shallowReactive, onErrorCaptured, reactive, effectScope, isReadonly, isShallow, isReactive, toRaw, createTextVNode, withModifiers, getCurrentScope, markRaw } from 'vue';
import { N as serialize, O as parseQuery, P as useSeoMeta$1, j as createError$1, Q as defu, R as headSymbol, S as klona, T as defuFn, U as useHead$1, V as hasProtocol, W as joinURL, X as getContext, Y as withQuery, C as withTrailingSlash, Z as withoutTrailingSlash, _ as isScriptProtocol, $ as isEqual, a0 as sanitizeStatusCode, a1 as withLeadingSlash, H as parseURL, a2 as $fetch$1, a3 as baseURL, a4 as createHooks, a5 as executeAsync, a6 as titleCase, a7 as toRouteMatcher, a8 as createRouter$1, a9 as camelCase, aa as withoutBase, ab as stringifyQuery, ac as withBase, ad as encodeParam, ae as encodePath } from '../nitro/nitro.mjs';
...
import { useForwardProps, Primitive, Slot, ToastProvider, ToastPortal, ToastViewport, ConfigProvider, TooltipProvider, useForwardPropsEmits, ToastRoot, ToastTitle, ToastDescription, ToastAction, ToastClose, TooltipRoot, TooltipTrigger, TooltipPortal, TooltipContent, TooltipArrow } from 'reka-ui';
...
const _routes = [
  {
    name: "clock",
    path: "/clock",
    component: () => import('./clock-rPodQgSt.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-BM0-cT4Y.mjs')
  },
  {
    name: "bookmarks",
    path: "/bookmarks",
    component: () => import('./bookmarks-BpSJSGP-.mjs')
  },
  {
    name: "projects",
    path: "/projects",
    component: () => import('./index-oYXjZ8Sy.mjs')
  },
  {
    name: "projects-slug",
    path: "/projects/:slug(.*)*",
    component: () => import('./_...slug_-CQyk5ehH.mjs')
  }
];
...
const LazyProseA = defineAsyncComponent(() => import('./ProseA-DCaxWFl3.mjs').then((r) => r["default"] || r.default || r));
...
const LazyProseH1 = defineAsyncComponent(() => import('./ProseH1-CTQzC2I0.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH2 = defineAsyncComponent(() => import('./ProseH2-nNjfpDbz.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH3 = defineAsyncComponent(() => import('./ProseH3-DxYksfPo.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH4 = defineAsyncComponent(() => import('./ProseH4-DLCtmw0W.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH5 = defineAsyncComponent(() => import('./ProseH5-C66QpdDA.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH6 = defineAsyncComponent(() => import('./ProseH6-DReJOsmi.mjs').then((r) => r["default"] || r.default || r));
const LazyProseHr = defineAsyncComponent(() => import('./ProseHr-Bidow6pB.mjs').then((r) => r["default"] || r.default || r));
const LazyProseImg = defineAsyncComponent(() => import('./ProseImg-DqrghtPE.mjs').then((r) => r["default"] || r.default || r));
...
const _sfc_main$e = /* @__PURE__ */ Object.assign({ inheritAttrs: false }, {
  ...
  setup(__props) {
    ...
    const ui = computed(() => {
      var _a2;
      return tv({ extend: tv(theme$6), ...((_a2 = appConfig2.ui) == null ? void 0 : _a2.avatar) || {} })({
        size: size.value
      });
    });
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            if (__props.src && !error.value) {
              ssrRenderVNode(_push2, createVNode(resolveDynamicComponent(unref(_sfc_main$f)), mergeProps({
                role: "img",
                src: __props.src,
                alt: __props.alt,
                width: sizePx.value,
            ...
            return [
              __props.src && !error.value ? (openBlock(), createBlock(resolveDynamicComponent(unref(_sfc_main$f)), mergeProps({
                key: 0,
                role: "img",
                src: __props.src,
                alt: __props.alt,
...
const _sfc_main$a = {
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const ui = computed(() => {
      var _a2;
      return tv({ extend: tv(theme$3), ...((_a2 = appConfig2.ui) == null ? void 0 : _a2.toast) || {} })({
        color: props.color,
...
const _sfc_main$9 = /* @__PURE__ */ Object.assign(__default__$1, {
  ...
  setup(__props) {
    ...
    const ui = computed(() => {
      var _a2;
      return tv({ extend: tv(theme$2), ...((_a2 = appConfig2.ui) == null ? void 0 : _a2.toaster) || {} })({
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  if (__props.toaster !== null) {
                    _push3(ssrRenderComponent(_sfc_main$9, toasterProps.value, {
                  ...
                  return [
                    __props.toaster !== null ? (openBlock(), createBlock(_sfc_main$9, mergeProps({ key: 0 }, toasterProps.value), {
                      default: withCtx(() => [
                        renderSlot(_ctx.$slots, "default")
                      ]),
                      _: 3
...
const _sfc_main$6 = {
  ...
  setup(__props) {
    ...
    const ui = computed(() => {
      var _a2;
      return tv({ extend: tv(theme$1), ...((_a2 = appConfig2.ui) == null ? void 0 : _a2.kbd) || {} });
    });
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(unref(Primitive), mergeProps({
        as: __props.as,
...
const _sfc_main$5 = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    const ui = computed(() => {
      var _a2;
      return tv({ extend: tv(theme), ...((_a2 = appConfig2.ui) == null ? void 0 : _a2.tooltip) || {} })({
...
const _sfc_main$2 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_UApp = _sfc_main$7;
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-CXrpF5Fw.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-iK4mSHuX.mjs'));
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = defineAsyncComponent(() => import('./island-renderer-Cc1Li-TK.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
    nuxtApp.deferHydration();
...
export { __nuxt_component_0$1 as _, useSeoMeta as a, _sfc_main$f as b, createError as c, __nuxt_component_0 as d, entry$1 as default, useRoute as e, useAsyncData as f, _sfc_main$b as g, _sfc_main$e as h, injectHead as i, useAppConfig as j, _sfc_main$g as k, useRuntimeConfig as l, tryUseNuxtApp as m, useOgImageRuntimeConfig as n, useSiteConfig as o, tv as t, useHead as u };
