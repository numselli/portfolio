import { _ as _sfc_main$1 } from './Container.vue.mjs';
import { _ as _sfc_main$2 } from './Header.vue.mjs';
import { g as useSeoMeta, h as _sfc_main$3 } from './server.mjs';
          ...
          if (_push2) {
            ...
            ssrRenderList(Object.keys(categories), (category) => {
              ...
              ssrRenderList(categories[category], (bookmark) => {
                _push2(`<li${_scopeId}><a${ssrRenderAttr("href", bookmark.url)} target="_blank" class="flex items-center gap-3 hover:bg-gray-100 dark:hover:bg-white/10 p-2 rounded-lg -m-2 text-sm min-w-0"${_scopeId}>`);
                _push2(ssrRenderComponent(_component_UAvatar, {
                  alt: bookmark.label,
                  ui: { rounded: "rounded-md" }
                }, null, _parent2, _scopeId));
                _push2(`<p class="truncate text-gray-700 dark:text-gray-200"${_scopeId}>${ssrInterpolate(bookmark.label)}</p><span class="flex-1"${_scopeId}></span><span class="text-xs font-medium text-gray-400 dark:text-gray-600"${_scopeId}>${ssrInterpolate(getHost(bookmark.url))}</span></a></li>`);
              });
              _push2(`<!--]--></div>`);
            });
            _push2(`<!--]--></ul></main>`);
                      ...
                      (openBlock(true), createBlock(Fragment, null, renderList(categories[category], (bookmark) => {
                        return openBlock(), createBlock("li", {
                          ...
                          createVNode("a", {
                            ...
                            createVNode("p", { class: "truncate text-gray-700 dark:text-gray-200" }, toDisplayString(bookmark.label), 1),
                            createVNode("span", { class: "flex-1" }),
                            createVNode("span", { class: "text-xs font-medium text-gray-400 dark:text-gray-600" }, toDisplayString(getHost(bookmark.url)), 1)
                          ], 8, ["href"])
                        ]);
                      }), 128))
                    ]);
...
//# sourceMappingURL=bookmarks.vue.mjs.map
