import { _ as __nuxt_component_0 } from './Avatar-D3VsDffL.mjs';
import { _ as _sfc_main$7 } from './NuxtImg-7AaQHZo2.mjs';
import { useSSRContext, withCtx, createVNode, defineComponent, toDisplayString, withAsyncContext, unref, mergeProps, createTextVNode } from 'vue';
import { ssrRenderComponent, ssrRenderAttrs, ssrRenderList, ssrInterpolate } from 'vue/server-renderer';
import { u as useHead, m as useAsyncData, q as queryContent, _ as _export_sfc, a as __nuxt_component_0$5, k as __nuxt_component_0$1 } from './server.mjs';
import { _ as _sfc_main$6 } from './ProjectCard-B0K2kk8r.mjs';
import { _ as __nuxt_component_0$2 } from './Button-BISzE-ou.mjs';
...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_AppProjectCard = _sfc_main$6;
...
//# sourceMappingURL=index-CWuUN0ck.mjs.map
