import { shallowReactive, reactive, effectScope, getCurrentScope, hasInjectionContext, getCurrentInstance, toRef, inject, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, defineAsyncComponent, computed, unref, toValue, ref, defineComponent, h, useAttrs, mergeProps, useSSRContext, withCtx, createTextVNode, toDisplayString, useSlots, resolveComponent, createVNode, resolveDynamicComponent, renderSlot, onServerPrefetch, createBlock, createCommentVNode, openBlock, provide, watch, Suspense, Fragment, onErrorCaptured, createApp } from 'vue';
import { F as createHooks, G as getContext, f as createError$1, I as toRouteMatcher, J as createRouter, K as defu, L as hasProtocol, M as joinURL, N as withQuery, O as sanitizeStatusCode, P as isScriptProtocol, Q as executeAsync, R as withoutTrailingSlash, S as titleCase, A as parseURL, T as withLeadingSlash, U as withBase, w as withTrailingSlash, V as camelCase, W as withoutBase, X as defuFn, Y as createDefu, Z as klona, _ as stringifyQuery, $ as parseQuery } from '../nitro/nitro.mjs';
...
const _0_routeRules_server_uokKinnH07zlS6m7PARncMDv8oZIH02DYA3gvwfcQwY = defineNuxtPlugin({
  enforce: "post",
  async setup() {
    const head = injectHead();
    if (!head)
...
const plugins = [
  ...
  _0_routeRules_server_uokKinnH07zlS6m7PARncMDv8oZIH02DYA3gvwfcQwY,
