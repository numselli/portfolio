...
import { b as useAppConfig, g as _sfc_main$i } from './server.mjs';
import 'lru-cache';
import '@unocss/core';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      if (icon.value) {
        _push(ssrRenderComponent(_sfc_main$i, mergeProps({ name: icon.value }, _attrs), null, _parent));
      } else {
        _push(`<!---->`);
      }
    };
...
//# sourceMappingURL=CodeIcon-Cn9GAbxw.mjs.map
