...
import { p as useSeoMeta, r as useRoute, s as useAsyncData, e as _sfc_main$c, I as ImageComponent, _ as __nuxt_component_0$2, q as __nuxt_component_0$1 } from './server.mjs';
import { withCtx, createVNode, defineComponent, withAsyncContext, unref, mergeProps, toDisplayString, createTextVNode, useSSRContext } from 'vue';
import { ssrRenderComponent, ssrRenderAttrs, ssrRenderList, ssrInterpolate } from 'vue/server-renderer';
import { _ as _export_sfc } from './_plugin-vue_export-helper-1tPrXgE0.mjs';
import { _ as _sfc_main$7 } from './ProjectCard-CqWCDbj0.mjs';
import { q as queryCollection } from './app-BnOcInKw.mjs';
import 'reka-ui';
...
const __nuxt_component_1 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$5, [["ssrRender", _sfc_ssrRender]]), { __name: "HomeIntro" });
...
const _sfc_main$3 = {
  ...
  async setup(__props) {
    ...
    const { data: projects } = ([__temp, __restore] = withAsyncContext(() => useAsyncData(route.path, () => queryCollection("projects").limit(3).all(), "$uZJq-IG3lB")), __temp = await __temp, __restore(), __temp);
    return (_ctx, _push, _parent, _attrs) => {
...
const __nuxt_component_4 = Object.assign(_sfc_main$1, { __name: "HomeFeaturedArticles" });
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_HomeFeaturedArticles = __nuxt_component_4;
...
//# sourceMappingURL=index-CQOWpgl9.mjs.map
