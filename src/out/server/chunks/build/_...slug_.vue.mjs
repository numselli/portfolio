import { _ as _sfc_main$6 } from './Container.vue.mjs';
import { j as useAppConfig, t as tv, k as _sfc_main$4, h as _sfc_main$5, l as useRuntimeConfig, d as useRoute, e as useAsyncData, g as useSeoMeta, _ as __nuxt_component_0, b as __nuxt_component_0$1 } from './server.mjs';
import { useSlots, computed, unref, mergeProps, withCtx, createVNode, createBlock, createCommentVNode, openBlock, Fragment, renderSlot, toDisplayString, useSSRContext, defineComponent, h, getCurrentInstance, toRaw, reactive, watch, resolveComponent, defineAsyncComponent, Text, Comment, withAsyncContext, renderList } from 'vue';
...
import { a9 as pascalCase, aa as kebabCase, j as destr } from '../nitro/nitro.mjs';
                ...
                createVNode("div", {
                  ...
                  renderSlot(_ctx.$slots, "default", {}, () => {
                    ...
                    return [
                      ...
                      }, toDisplayString(__props.label), 3)) : __props.icon ? (openBlock(), createBlock(_sfc_main$4, {
                        key: 1,
                        name: __props.icon,
                        class: ui.value.icon({ class: (_b2 = props.ui) == null ? void 0 : _b2.icon })
