import { hasInjectionContext, inject, version, ref, watchEffect, watch, getCurrentInstance, h, toRef, isRef, defineComponent, provide, createElementBlock, defineAsyncComponent, computed, useAttrs, toValue, useSSRContext, shallowReactive, Suspense, nextTick, Fragment, Transition, unref, resolveComponent, shallowRef, createVNode, resolveDynamicComponent, mergeProps, withCtx, renderSlot, withAsyncContext, createApp, effectScope, reactive, getCurrentScope, onErrorCaptured, onServerPrefetch, isReadonly, isShallow, isReactive, toRaw, openBlock, createBlock, createCommentVNode, toDisplayString, createTextVNode } from 'vue';
import { $ as $fetch$1, i as createError$1, M as defuFn, N as klona, y as defu, x as withoutTrailingSlash, O as withLeadingSlash, P as joinURL, l as hash$3, Q as parseQuery, R as withBase, S as createDefu$1, T as isEqual, U as createHooks, V as parse, W as getRequestHeader, X as hasProtocol, Y as isScriptProtocol, C as withQuery, n as destr, Z as setCookie, _ as getCookie, a0 as deleteCookie, a1 as sanitizeStatusCode, G as withTrailingSlash, p as parseURL, v as toRouteMatcher, w as createRouter$1, z as withoutBase, a2 as hasTrailingSlash } from '../runtime.mjs';
...
import { addAPIProvider, loadIcon, _api, disableCache } from '@iconify/vue';
...
const _routes = [
  {
    name: "slug",
    path: "/:slug(.*)*",
    component: () => import('./document-driven-BzMUql6t.mjs').then((m) => m.default || m)
  },
  {
    name: "bookmarks",
    path: "/bookmarks",
    component: () => import('./bookmarks-5cKKDXPN.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-GZsOXXR4.mjs').then((m) => m.default || m)
  },
  {
    name: "projects-slug",
    path: "/projects/:slug(.*)*",
    component: () => import('./_...slug_-CnH79w1H.mjs').then((m) => m.default || m)
  },
  {
    name: "projects",
    path: "/projects",
    component: () => import('./index-zh9lEk-P.mjs').then((m) => m.default || m)
  }
];
...
const LazyAnimatedCounter = defineAsyncComponent(() => import('./AnimatedCounter-BBTOFgO8.mjs').then((r) => r["default"] || r.default || r));
const LazyCodeView = defineAsyncComponent(() => import('./CodeView-8hdoeNAA.mjs').then((r) => r["default"] || r.default || r));
const LazyCredit = defineAsyncComponent(() => import('./Credit-QQdbP1pS.mjs').then((r) => r["default"] || r.default || r));
const LazyTextRotator = defineAsyncComponent(() => import('./TextRotator-BNVbhNCi.mjs').then((r) => r["default"] || r.default || r));
const LazyContentDoc = defineAsyncComponent(() => import('./ContentDoc-CyYkilCx.mjs').then((r) => r["default"] || r.default || r));
const LazyContentList = defineAsyncComponent(() => import('./ContentList-BTozBsM4.mjs').then((r) => r["default"] || r.default || r));
const LazyContentNavigation = defineAsyncComponent(() => import('./ContentNavigation-BH-eXmMo.mjs').then((r) => r["default"] || r.default || r));
const LazyContentQuery = defineAsyncComponent(() => import('./ContentQuery-CcT5Pwe_.mjs').then((r) => r["default"] || r.default || r));
const LazyContentRenderer = defineAsyncComponent(() => import('./ContentRenderer-C0VSUtN7.mjs').then((r) => r["default"] || r.default || r));
const LazyContentRendererMarkdown = defineAsyncComponent(() => import('./ContentRendererMarkdown-CFDJ0LI2.mjs').then((r) => r["default"] || r.default || r));
...
const LazyProseCodeInline = defineAsyncComponent(() => import('./ProseCodeInline-BRHaoPuP.mjs').then((r) => r["default"] || r.default || r));
const LazyProsePre = defineAsyncComponent(() => import('./ProsePre-BCe7-UHp.mjs').then((r) => r["default"] || r.default || r));
const LazyProseA = defineAsyncComponent(() => import('./ProseA-JlpUVKSd.mjs').then((r) => r["default"] || r.default || r));
const LazyProseBlockquote = defineAsyncComponent(() => import('./ProseBlockquote-CNto8Nto.mjs').then((r) => r["default"] || r.default || r));
const LazyProseEm = defineAsyncComponent(() => import('./ProseEm-UQjt1Kc9.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH1 = defineAsyncComponent(() => import('./ProseH1-DS6eKISU.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH2 = defineAsyncComponent(() => import('./ProseH2-C70b-J6b.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH3 = defineAsyncComponent(() => import('./ProseH3-BCgo0dyC.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH4 = defineAsyncComponent(() => import('./ProseH4-CZQpYCXF.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH5 = defineAsyncComponent(() => import('./ProseH5-s-dZfo3z.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH6 = defineAsyncComponent(() => import('./ProseH6-BNF3oUuk.mjs').then((r) => r["default"] || r.default || r));
const LazyProseHr = defineAsyncComponent(() => import('./ProseHr-XpI1CGFK.mjs').then((r) => r["default"] || r.default || r));
const LazyProseImg = defineAsyncComponent(() => import('./ProseImg-U9fumw1P.mjs').then((r) => r["default"] || r.default || r));
const LazyProseLi = defineAsyncComponent(() => import('./ProseLi-BYNqRtUP.mjs').then((r) => r["default"] || r.default || r));
const LazyProseOl = defineAsyncComponent(() => import('./ProseOl-C-TzFmET.mjs').then((r) => r["default"] || r.default || r));
const LazyProseP = defineAsyncComponent(() => import('./ProseP-Rpfw0QAq.mjs').then((r) => r["default"] || r.default || r));
const LazyProseScript = defineAsyncComponent(() => import('./ProseScript-D0R07iM6.mjs').then((r) => r["default"] || r.default || r));
const LazyProseStrong = defineAsyncComponent(() => import('./ProseStrong-SJ_s33Id.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTable = defineAsyncComponent(() => import('./ProseTable-CJHEypnO.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTbody = defineAsyncComponent(() => import('./ProseTbody-DlblVNLn.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTd = defineAsyncComponent(() => import('./ProseTd-BGwzn9K1.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTh = defineAsyncComponent(() => import('./ProseTh-CmYYVajJ.mjs').then((r) => r["default"] || r.default || r));
const LazyProseThead = defineAsyncComponent(() => import('./ProseThead-C0E_UmGH.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTr = defineAsyncComponent(() => import('./ProseTr-BmRAzKo1.mjs').then((r) => r["default"] || r.default || r));
const LazyProseUl = defineAsyncComponent(() => import('./ProseUl-CP1eFzTS.mjs').then((r) => r["default"] || r.default || r));
const LazyIcon = defineAsyncComponent(() => Promise.resolve().then(function() {
  return Icon;
}).then((r) => r["default"] || r.default || r));
const LazyIconCSS = defineAsyncComponent(() => import('./IconCSS-CPIyaEI3.mjs').then((r) => r["default"] || r.default || r));
...
function hash$2(object, options = {}) {
...
const productResolver = defineSchemaOrgResolver({
  ...
  resolve(node, ctx) {
    setIfEmpty(node, "sku", hash$2(node.name));
...
function dedupeNodes(nodes) {
  ...
  for (const key of nodes.keys()) {
    const n = nodes[key];
    const nodeKey = resolveAsGraphKey(n["@id"] || hash$2(n));
...
const createQueryFetch = () => async (query) => {
  ...
  const apiPath = content.experimental.stripQueryParameters ? withContentBase(`/query/${`${hash$3(params)}.${content.integrity}`}/${encodeQueryParams(params)}.json`) : withContentBase(`/query/${hash$3(params)}.${content.integrity}.json`);
  {
    addPrerenderPath(apiPath);
  }
  if (shouldUseClientDB()) {
    const db = await import('./client-db-DX7QaHnk.mjs').then((m) => m.useContentDatabase());
...
const fetchContentNavigation = async (queryBuilder) => {
  ...
  const apiPath = content.experimental.stripQueryParameters ? withContentBase(`/navigation/${`${hash$3(params)}.${content.integrity}`}/${encodeQueryParams(params)}.json`) : withContentBase(`/navigation/${hash$3(params)}.${content.integrity}.json`);
  {
    addPrerenderPath(apiPath);
  }
  if (shouldUseClientDB()) {
    const generateNavigation = await import('./client-db-DX7QaHnk.mjs').then((m) => m.generateNavigation);
...
const __nuxt_component_0$3 = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["ssrRender", _sfc_ssrRender$2]]);
...
const __nuxt_component_0$2 = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["ssrRender", _sfc_ssrRender$1]]);
...
const __nuxt_component_0$1 = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["ssrRender", _sfc_ssrRender]]);
const iconCollections = ["fluent-emoji-high-contrast", "material-symbols-light", "cryptocurrency-color", "icon-park-outline", "icon-park-twotone", "fluent-emoji-flat", "emojione-monotone", "streamline-emojis", "heroicons-outline", "simple-line-icons", "material-symbols", "flat-color-icons", "icon-park-solid", "pepicons-pencil", "heroicons-solid", "pepicons-print", "cryptocurrency", "pixelarticons", "system-uicons", "bitcoin-icons", "entypo-social", "token-branded", "devicon-plain", "grommet-icons", "pepicons-pop", "svg-spinners", "fluent-emoji", "simple-icons", "circle-flags", "vscode-icons", "medical-icon", "icomoon-free", "majesticons", "radix-icons", "humbleicons", "fa6-regular", "rivet-icons", "emojione-v1", "skill-icons", "academicons", "healthicons", "fluent-mdl2", "teenyicons", "ant-design", "gravity-ui", "akar-icons", "lets-icons", "streamline", "fa6-brands", "file-icons", "catppuccin", "game-icons", "foundation", "fa-regular", "mono-icons", "hugeicons", "iconamoon", "zondicons", "mdi-light", "eos-icons", "gridicons", "icon-park", "heroicons", "fa6-solid", "meteocons", "arcticons", "dashicons", "fa-brands", "websymbol", "fontelico", "mingcute", "flowbite", "marketeq", "bytesize", "guidance", "openmoji", "emojione", "nonicons", "brandico", "flagpack", "fa-solid", "fontisto", "si-glyph", "pepicons", "iconoir", "tdesign", "clarity", "octicon", "pajamas", "formkit", "line-md", "twemoji", "noto-v1", "fxemoji", "codicon", "devicon", "raphael", "flat-ui", "topcoat", "feather", "tabler", "carbon", "lucide", "memory", "mynaui", "circum", "fluent", "nimbus", "entypo", "icons8", "subway", "vaadin", "solar", "basil", "typcn", "charm", "prime", "quill", "logos", "token", "covid", "maki", "weui", "gala", "mage", "ooui", "noto", "flag", "unjs", "iwwa", "zmdi", "bpmn", "mdi", "ion", "uil", "bxs", "cil", "uiw", "uim", "uit", "uis", "jam", "oui", "bxl", "cib", "cbi", "cif", "gis", "map", "geo", "fad", "eva", "wpf", "whh", "ic", "ph", "ri", "bi", "bx", "gg", "ci", "ep", "fe", "mi", "f7", "ei", "wi", "la", "fa", "oi", "et", "el", "ls", "vs", "il", "ps"];
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["__scopeId", "data-v-e8d572f6"]]);
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-BgHo1mjC.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./error-500-BKcmTTav.mjs').then((r) => r.default || r));
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = defineAsyncComponent(() => import('./island-renderer-BITwa4rY.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
...
export { assertArray as A, ensureArray as B, omit$1 as C, sortList as D, apply as E, withoutKeys as F, withKeys as G, createQuery as H, useOgImageRuntimeConfig as I, useSiteConfig as J, LayoutMetaSymbol as L, PageRouteSymbol as P, _export_sfc as _, __nuxt_component_0$5 as a, useNuxtApp as b, createError as c, useRoute as d, entry$1 as default, appLayoutTransition as e, _wrapIf as f, useRuntimeConfig as g, useContent as h, useRequestEvent as i, __nuxt_component_0 as j, appConfig as k, layouts as l, mergeConfig as m, useUI as n, __nuxt_component_0$1 as o, nuxtLinkProps as p, queryContent as q, getNuxtLinkProps as r, useState as s, fetchContentNavigation as t, useHead as u, asyncDataDefaults as v, useContentPreview as w, useAppConfig as x, resolveIconName as y, get$1 as z };
