import { _ as __nuxt_component_0, a as __nuxt_component_1 } from './Avatar-D3VsDffL.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    useHead({
      meta: [
        { name: "description", content: "A collection of useful links." }
      ]
    });
    const categories = {
...
//# sourceMappingURL=bookmarks-DVRcuMMd.mjs.map
