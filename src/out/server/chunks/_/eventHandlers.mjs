import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { t as prefixStorage, v as useStorage, w as useNitroOrigin, x as emojiCache, y as useOgImageRuntimeConfig, j as createError, z as fetchIsland, A as createHeadCore, B as normaliseFontInput, C as theme, D as withTrailingSlash, i as getQuery, E as handleCacheHeaders, F as setHeaders, G as setHeader, H as hash, I as parseURL, J as setResponseHeader, K as proxyRequest, L as sendRedirect, M as resolveContext, N as H3Error } from '../nitro/nitro.mjs';
