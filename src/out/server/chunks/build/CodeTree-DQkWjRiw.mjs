...
import { b as useAppConfig, t as tv, g as _sfc_main$l } from './server.mjs';
import _sfc_main$1 from './CodeIcon-BJyIRrV8.mjs';
                  ...
                  if (_push3) {
                    ...
                    return [
                      createVNode("button", {
                        ...
                        item.children?.length ? (openBlock(), createBlock(_sfc_main$l, {
                          key: 0,
                          name: isExpanded ? unref(appConfig).ui.icons.folderOpen : unref(appConfig).ui.icons.folder,
                          class: ui.value.linkLeadingIcon({ class: props.ui?.linkLeadingIcon })
...
//# sourceMappingURL=CodeTree-DQkWjRiw.mjs.map
