import { withAsyncContext, mergeProps, unref, withCtx, createTextVNode, computed, toRaw, defineComponent, resolveComponent, defineAsyncComponent, h, getCurrentInstance, reactive, watch, Text, Comment, useSSRContext } from 'vue';
import { ssrRenderAttrs, ssrInterpolate, ssrRenderComponent, ssrRenderSlot } from 'vue/server-renderer';
import { an as pascalCase, ao as kebabCase, ap as destr } from '../nitro/nitro.mjs';
import { find, html } from 'property-information';
import { toHast } from 'minimark/hast';
import { e as useRoute, f as useAsyncData, a as useSeoMeta, _ as __nuxt_component_0$1, k as useRuntimeConfig } from './server.mjs';
    ...
    function resolveVueComponent(component) {
      ...
      if (typeof component === "string") {
        ...
        if (globalComponents.includes(pascalCase(component))) {
          ...
          const loader = () => {
            return Promise.resolve().then(() => virtual_nuxt__2Fhome_2Frunner_2Fwork_2Fportfolio_2Fportfolio_2Fsrc_2F_nuxt_2Fcontent_2Fcomponents).then((m) => {
...
//# sourceMappingURL=_...slug_-Dqz11HRp.mjs.map
