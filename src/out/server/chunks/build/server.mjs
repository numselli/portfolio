import { defineComponent, shallowRef, h, resolveComponent, toRef, inject, computed, provide, useSlots, ref, mergeProps, unref, withCtx, renderSlot, createBlock, createCommentVNode, openBlock, toDisplayString, createVNode, toValue, hasInjectionContext, watch, resolveDynamicComponent, mergeModels, useModel, createTextVNode, getCurrentInstance, onServerPrefetch, useAttrs, isRef, nextTick, createElementBlock, cloneVNode, defineAsyncComponent, useSSRContext, Suspense, Fragment, createApp, renderList, useId, shallowReactive, onErrorCaptured, reactive, effectScope, isReadonly, isShallow, isReactive, toRaw, withModifiers, getCurrentScope, markRaw } from 'vue';
import { P as serialize, Q as parseQuery, R as klona, S as defuFn, j as createError$1, T as defu, U as headSymbol, V as useSeoMeta$1, W as useHead$1, X as hasProtocol, Y as joinURL, Z as isEqual, _ as getContext, $ as withQuery, E as withTrailingSlash, a0 as withoutTrailingSlash, a1 as isScriptProtocol, a2 as sanitizeStatusCode, a3 as withLeadingSlash, J as parseURL, a4 as $fetch$1, a5 as baseURL, a6 as createHooks, a7 as executeAsync, a8 as titleCase, a9 as encodeParam, aa as encodePath, ab as toRouteMatcher, ac as createRouter$1, ad as camelCase, ae as withoutBase, af as stringifyQuery, ag as withBase, ah as resolveUnrefHeadInput } from '../nitro/nitro.mjs';
...
const _routes = [
  {
    name: "clock",
    path: "/clock",
    component: () => import('./clock-ByaJBFR4.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-CQOWpgl9.mjs')
  },
  {
    name: "bookmarks",
    path: "/bookmarks",
    component: () => import('./bookmarks-DZFm2QvT.mjs')
  },
  {
    name: "projects",
    path: "/projects",
    component: () => import('./index-PWKTM2OG.mjs')
  },
  {
    name: "projects-slug",
    path: "/projects/:slug(.*)*",
    component: () => import('./_...slug_-Cl4b1ry0.mjs')
  }
];
...
const LazyProseA = defineAsyncComponent(() => import('./ProseA-CKvlRjtS.mjs').then((r) => r["default"] || r.default || r));
...
const LazyProseH1 = defineAsyncComponent(() => import('./ProseH1-CT1miaKz.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH2 = defineAsyncComponent(() => import('./ProseH2-CIcg8I2A.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH3 = defineAsyncComponent(() => import('./ProseH3-CElH8hof.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH4 = defineAsyncComponent(() => import('./ProseH4-DJJz0l5M.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH5 = defineAsyncComponent(() => import('./ProseH5-BIRX370H.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH6 = defineAsyncComponent(() => import('./ProseH6-BkIz84A2.mjs').then((r) => r["default"] || r.default || r));
const LazyProseHr = defineAsyncComponent(() => import('./ProseHr-3bktmzoE.mjs').then((r) => r["default"] || r.default || r));
const LazyProseImg = defineAsyncComponent(() => import('./ProseImg-Cia0jq9Z.mjs').then((r) => r["default"] || r.default || r));
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-BtBmqFwr.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-BC_MxJyY.mjs'));
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = defineAsyncComponent(() => import('./island-renderer-Bdc-62ho.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
    nuxtApp.deferHydration();
...
export { ImageComponent as I, __nuxt_component_0$2 as _, useLocale as a, useAppConfig as b, createError as c, usePortal as d, entry$1 as default, _sfc_main$c as e, useButtonGroup as f, useComponentIcons as g, _sfc_main$i as h, injectHead as i, _sfc_main$f as j, get as k, useFormField as l, isArrayOfArray as m, _sfc_main$g as n, getDisplayValue as o, useSeoMeta as p, __nuxt_component_0$1 as q, useRoute as r, useAsyncData as s, tv as t, useHead as u, useRuntimeConfig as v, tryUseNuxtApp as w, useOgImageRuntimeConfig as x, useSiteConfig as y };
