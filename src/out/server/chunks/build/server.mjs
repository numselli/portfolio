import { hasInjectionContext, inject, version, ref, watchEffect, watch, getCurrentInstance, h, shallowRef, toRef, onServerPrefetch, isRef, defineAsyncComponent, computed, defineComponent, useAttrs, toValue, useSSRContext, provide, shallowReactive, Suspense, nextTick, Fragment, Transition, unref, resolveComponent, createVNode, resolveDynamicComponent, mergeProps, withCtx, renderSlot, createApp, effectScope, reactive, getCurrentScope, onErrorCaptured, isReadonly, isShallow, isReactive, toRaw, openBlock, createBlock, createCommentVNode, toDisplayString, createTextVNode } from 'vue';
import { $ as $fetch$1, i as createError$1, O as defuFn, n as defu, w as withoutTrailingSlash, P as withLeadingSlash, Q as joinURL, q as hash$2, R as parseQuery, S as klona, T as withBase, U as createDefu, V as isEqual, W as createHooks, X as parse, Y as getRequestHeader, Z as hasProtocol, _ as isScriptProtocol, A as withQuery, m as destr, a0 as setCookie, a1 as getCookie, a2 as deleteCookie, a3 as sanitizeStatusCode, H as withTrailingSlash, t as toRouteMatcher, v as createRouter$1, z as parseURL, x as withoutBase, a4 as stringifyQuery } from '../runtime.mjs';
...
const _routes = [
  {
    name: "slug",
    path: "/:slug(.*)*",
    component: () => import('./document-driven-Bb1c2VqO.mjs')
  },
  {
    name: "bookmarks",
    path: "/bookmarks",
    component: () => import('./bookmarks-DuluBPi9.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-CFQsAYU_.mjs')
  },
  {
    name: "projects-slug",
    path: "/projects/:slug(.*)*",
    component: () => import('./_...slug_-mN5j0JfQ.mjs')
  },
  {
    name: "projects",
    path: "/projects",
    component: () => import('./index-CJ4l-l4J.mjs')
  }
];
...
const LazyAnimatedCounter = defineAsyncComponent(() => import('./AnimatedCounter-CHion6WM.mjs').then((r) => r["default"] || r.default || r));
...
const LazyTextRotator = defineAsyncComponent(() => import('./TextRotator-Ceewwr2y.mjs').then((r) => r["default"] || r.default || r));
const LazyContentDoc = defineAsyncComponent(() => import('./ContentDoc-BQFyMSY9.mjs').then((r) => r["default"] || r.default || r));
...
const LazyContentRenderer = defineAsyncComponent(() => import('./ContentRenderer-8vkAJ7Z_.mjs').then((r) => r["default"] || r.default || r));
const LazyContentRendererMarkdown = defineAsyncComponent(() => import('./ContentRendererMarkdown-lfgYCj4t.mjs').then((r) => r["default"] || r.default || r));
...
const LazyProseA = defineAsyncComponent(() => import('./ProseA-CyZqSAir.mjs').then((r) => r["default"] || r.default || r));
...
const LazyProseH1 = defineAsyncComponent(() => import('./ProseH1-DTopSmvJ.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH2 = defineAsyncComponent(() => import('./ProseH2-Day0zHCF.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH3 = defineAsyncComponent(() => import('./ProseH3-D4jFg6am.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH4 = defineAsyncComponent(() => import('./ProseH4-CBREXC1r.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH5 = defineAsyncComponent(() => import('./ProseH5-oC3OhPg4.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH6 = defineAsyncComponent(() => import('./ProseH6-D4ygi7r1.mjs').then((r) => r["default"] || r.default || r));
const LazyProseHr = defineAsyncComponent(() => import('./ProseHr-B-16DMbq.mjs').then((r) => r["default"] || r.default || r));
const LazyProseImg = defineAsyncComponent(() => import('./ProseImg-NyOGCT67.mjs').then((r) => r["default"] || r.default || r));
...
const umConfig = computed(() => {
  ...
  const version2 = host && host.includes("umami.is") ? 2 : _ver;
  return {
    host,
    id: umamiId || id,
    domains,
...
const helloDebugger = computed(() => {
  const enabled = umConfig.value.debug;
  return enabled ? debug : (..._params) => void 0;
});
computed(() => {
...
const endpoint = computed(() => {
  const { host, customEndpoint, version: version2 } = umConfig.value;
  const { host: urlHost = "", protocol = "" } = host ? new URL(host) : {};
  const branch = customEndpoint || (version2 === 2 ? "/api/send" : "/api/collect");
...
const getPayload = computed(() => {
  ...
  const pageRef = referrer || query.ref || "";
  return {
...
function trackView(url, referrer) {
  ...
  const { id: website, version: version2 } = umConfig.value;
  const payload = getPayload.value;
  return collect(
    {
      type: version2 === 2 ? "event" : "pageview",
      payload: {
        website,
        ...payload,
...
function trackEvent(eventName, eventData) {
  ...
  const eventObj = version2 === 2 ? { name, data } : { event_name: name, event_data: data };
  return collect({
    type: "event",
    payload: {
      ...payload,
...
const umami_5KgQP7X3nR = /* @__PURE__ */ defineNuxtPlugin({
  name: "umami-tracker",
  async setup(nuxtApp) {
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-BFEeXGmK.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-DLYp63Zr.mjs'));
