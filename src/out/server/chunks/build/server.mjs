...
import { S as serialize, T as parseQuery, U as klona, V as defuFn, j as createError$1, W as defu, X as headSymbol, Y as useSeoMeta$1, Z as useHead$1, t as hasProtocol, v as joinURL, _ as isEqual, $ as getContext, a0 as withQuery, H as withTrailingSlash, a1 as withoutTrailingSlash, a2 as isScriptProtocol, a3 as sanitizeStatusCode, a4 as withLeadingSlash, M as parseURL, a5 as $fetch$1, a6 as baseURL, a7 as createHooks, a8 as executeAsync, a9 as titleCase, aa as encodeParam, ab as encodePath, ac as toRouteMatcher, ad as createRouter$1, ae as camelCase, af as withoutBase, ag as stringifyQuery, ah as withBase, ai as resolveUnrefHeadInput } from '../nitro/nitro.mjs';
...
const _routes = [
  {
    name: "clock",
    path: "/clock",
    component: () => import('./clock-CuybuYfi.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-DVUj1gQH.mjs')
  },
  {
    name: "bookmarks",
    path: "/bookmarks",
    component: () => import('./bookmarks-7YgSBCkx.mjs')
  },
  {
    name: "projects",
    path: "/projects",
    component: () => import('./index-CNCPRb3d.mjs')
  },
  {
    name: "projects-slug",
    path: "/projects/:slug(.*)*",
    component: () => import('./_...slug_-DHgSV7u6.mjs')
  }
];
...
const LazyProseA = defineAsyncComponent(() => import('./ProseA-BvwDh19m.mjs').then((r) => r["default"] || r.default || r));
...
const LazyProseH1 = defineAsyncComponent(() => import('./ProseH1-BCDf3UMW.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH2 = defineAsyncComponent(() => import('./ProseH2-duzQMZvk.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH3 = defineAsyncComponent(() => import('./ProseH3-B9NFoi_y.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH4 = defineAsyncComponent(() => import('./ProseH4-pHuVWCn5.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH5 = defineAsyncComponent(() => import('./ProseH5-B5Zz1B6Y.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH6 = defineAsyncComponent(() => import('./ProseH6-DMpQ55Gh.mjs').then((r) => r["default"] || r.default || r));
const LazyProseHr = defineAsyncComponent(() => import('./ProseHr-3bktmzoE.mjs').then((r) => r["default"] || r.default || r));
const LazyProseImg = defineAsyncComponent(() => import('./ProseImg-Bx2Co-tx.mjs').then((r) => r["default"] || r.default || r));
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-DGUDiN-q.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-CXanyzrU.mjs'));
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = defineAsyncComponent(() => import('./island-renderer-D0i6-R4f.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
    nuxtApp.deferHydration();
